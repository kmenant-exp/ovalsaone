...
name: 'Idea Generator'
tools: ['search/changes', 'search/codebase', 'web/fetch', 'githubRepo', 'openSimpleBrowser', 'read/problems', 'search', 'searchResults', 'search/usages', 'microsoft.docs.mcp', 'websearch']
---
